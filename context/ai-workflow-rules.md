...
These should remain default and resuable.

Project-specifice styling , layout changes and feature logic must be implemented in app-level components instead of modifying foundation components.
