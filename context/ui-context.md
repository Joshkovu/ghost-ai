...
8 defined color pairs. Each pair specifies a dark node fill and a vivid contrasting text 
color tuned for readability on the dark canvas. Defined in `types/canvas.ts` as `NODE_COLORS`

| Node fill           | Text color        | Character   |
| --------------- | ------------------ | -------- |
| `#1F1F1F` | `#EDEDED`        | Neutral dark |
| `#10233D`         | `#52A8FF`     | Blue |
